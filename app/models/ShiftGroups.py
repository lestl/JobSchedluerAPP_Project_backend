...
from models.Enums import ShiftGroup as ShiftGroupEnum
from db import Base
...
class ShiftGroup(Base):
    ...
    name = Column(SAEnum(ShiftGroupEnum), nullable=False, comment="The A group, B group...")
    ...
    employee = relationship("Employee", backref="shiftgroups")
